...
extrap_dict = pickle.load(open(os.path.join(pth, 'constant_isoscalar_Emin_50GeV'), 'rb'), encoding='latin1')

def get_weight_iso(E, nu='Nu', current='CC', ext_type='constant', lgE_min_cust=1.68, coef=1.):
